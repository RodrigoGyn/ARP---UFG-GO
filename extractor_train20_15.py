...
def gerador_Header():
    ...
    text_file.write("@ATTRIBUTE Hue10" + " " + "REAL" + "\n")
    text_file.write("@ATTRIBUTE Hue11" + " " + "REAL" + "\n")
    text_file.write("@ATTRIBUTE Hue12" + " " + "REAL" + "\n")
    text_file.write("@ATTRIBUTE Hue13" + " " + "REAL" + "\n")
    text_file.write("@ATTRIBUTE Hue14" + " " + "REAL" + "\n")
