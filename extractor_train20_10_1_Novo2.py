...
def gerador_Header():
    ...
    file = "image_features_train_20_10_1_Novo2.arff"
    ...
    text_file.write("@ATTRIBUTE Morph0" + " " + "REAL" + "\n")
    text_file.write("@ATTRIBUTE Morph1" + " " + "REAL" + "\n")
    text_file.write("@ATTRIBUTE Morph2" + " " + "REAL" + "\n")
    text_file.write("@ATTRIBUTE Morph3" + " " + "REAL" + "\n")
    text_file.write("@ATTRIBUTE Morph4" + " " + "REAL" + "\n")
    text_file.write("@ATTRIBUTE Morph5" + " " + "REAL" + "\n")
    text_file.write("@ATTRIBUTE Morph6" + " " + "REAL" + "\n")
    text_file.write("@ATTRIBUTE Morph7" + " " + "REAL" + "\n")
    text_file.write("@ATTRIBUTE Morph8" + " " + "REAL" + "\n")
...
def feature_extractor():
    ...
    trainPath = "C:/Python27/ARP/Dataset/train"
